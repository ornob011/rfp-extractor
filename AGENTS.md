# RFP Extractor - AGENTS Session Bootstrap

## Purpose

`AGENTS.md` is the project-level session bootstrap (system-prompt equivalent) for AGENTS Code.

- Sprint docs define what to build.
- `AGENTS.md` defines how to build and where to navigate.
...
| Validate cross-sprint contract | `docs/003_implementation-index.md` | `AGENTS.md`                        |
| Architecture decision          | `docs/002_plan.md`                 | `docs/003_implementation-index.md` |
| Enum/persistence convention    | `AGENTS.md`                        | sprint doc being implemented       |
| Prompt handling                | `AGENTS.md`                        | sprint doc + `/prompts/` files     |
